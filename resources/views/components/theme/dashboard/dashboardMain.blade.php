<div class="dashboard--area-main pt--100 pt_sm--50">
    <div class="container">
        <div class="row g-5">
            <x-theme.dashboard.leftSideMenu />
            <div class="col-lg-9">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-progress-course">
                                <a href="single-course.html" class="thumbnail">
                                    <img src="frontend/assets/images/dashboard/02.jpg" alt="img">
                                </a>
                                <div class="information-progress-course">
                                    ...
                                    <a href="single-course.html">
                                        <h5 class="title">User Experience The Ultimate Guide to Usability and UX
                                        </h5>
                                    </a>
                            ...
                            <div class="single-progress-course">
                                <a href="single-course.html" class="thumbnail">
                                    <img src="frontend/assets/images/dashboard/03.jpg" alt="img">
                                </a>
                                <div class="information-progress-course">
                                    <div class="rating-area">
                                        <i class="fa-light fa-star"></i>
                            ...
                            <div class="single-progress-course">
                                <a href="single-course.html" class="thumbnail">
                                    <img src="frontend/assets/images/dashboard/04.jpg" alt="img">
                                </a>
                                <div class="information-progress-course">
                                    <div class="rating-area">
                                        <i class="fa-light fa-star"></i>
