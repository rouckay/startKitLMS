            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="about-one-left-image">
                        <div class="first-order">
                            <div class="thumb-one">
                                <img src="frontend/assets/images/about/03.jpg" alt="about">
                ...
                <div class="col-xl-6 col-lg-12 pl--60 pl_lg--15 pl_md--10 pl_sm--10 pt_lg--50 pt_md--50 pt_sm--50">
                    <div class="title-area-left-style">
                        <div class="pre-title">
                            <img src="frontend/assets/images/banner/bulb.png" alt="icon">
                    ...
                    <div class="about-inner-right-one">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="frontend/assets/images/about/icon/01.png" alt="icon-image">
                                </div>
                                <div class="information">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="frontend/assets/images/about/icon/02.png" alt="icon-image">
                                </div>
                                <div class="information">
                        ...
                        <div class="author-area">
                            <div class="single-author-and-info">
                                <img src="frontend/assets/images/about/01.png" alt="about">
                                <div class="information">
                                    <a href="#">
