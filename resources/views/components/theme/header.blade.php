                        ...
                        <div class="right-information">
                            <ul class="rts-dropdown-menu switcher-language">
                                <li class="has-child-menu">
                                    <a href="#">
                                        <img class="left-image" src="frontend/assets/images/flag-01.svg"
                                            alt="Language Images">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">
                                                <img class="left-image" src="frontend/assets/images/flag-03.svg"
                                                    alt="Language Images">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="left-image" src="frontend/assets/images/flag-02.svg"
                                                    alt="Language Images">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="left-image" src="frontend/assets/images/flag-04.svg"
                                                    alt="Language Images">
                ...
                <div class="header-one-wrapper">
                    <div class="left-side-header">
                        <a href="index-2.html" class="logo-area">
                            <img src="frontend/assets/images/logo/logo-1.svg" alt="logo">
                        </a>
                        <div class="category-area">
                            <div class="category-btn">
                                <img src="frontend/assets/images/header/grid.png" alt="grid">
                                <span>Category</span>
                                ...
                                <ul class="category-sub-menu">
                                    <li>
                                        <ul>
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/01.svg" alt="">
                                                    <div class="text">
                                                        <h4>Development</h4>
                                                        <p>130+ Courses</p>
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/07.svg" alt="">
                                                    <div class="text">
                                                        <h4>Academics</h4>
                                                        <p>130+ Courses</p>
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/02.svg" alt="">
                                                    <div class="text">
                                                        <h4>Business</h4>
                                                        <p>150+ Courses</p>
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/03.svg" alt="">
                                                    <div class="text">
                                                        <h4>Design & Art</h4>
                                                        <p>120+ Courses</p>
                                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/04.svg" alt="">
                                                    <div class="text">
                                                        <h4>Marketing</h4>
                                                        <p>130+ Courses</p>
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/05.svg" alt="">
                                                    <div class="text">
                                                        <h4>Music</h4>
                                                        <p>100+ Courses</p>
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/08.svg" alt="">
                                                    <div class="text">
                                                        <h4>Photography</h4>
                                                        <p>150+ Courses</p>
                                                    </div>
                                            ...
                                            <li>
                                                <a href="#" class="menu-item">
                                                    <img src="frontend/assets/images/category/06.svg" alt="">
                                                    <div class="text">
                                                        <h4>Accounting</h4>
                                                        <p>150+ Courses</p>
                                                    </div>
                                    ...
                                    <ul class="megamenu-hub">
                                        <li>
                                            ...
                                            <div class="absolute-image-shape shape-image">
                                                <img class=" shape one" src="frontend/assets/images/nav/02.png"
                                                    data-speed="0.04" data-revert="true" alt="nav">
                                                <img class=" shape two" src="frontend/assets/images/nav/03.png"
                                                    data-speed="0.04" alt="nav">
                                            </div>
                                            <div class="nav-mega-image">
                                                <a href="single-course.html">
                                                    <img src="frontend/assets/images/nav/01.jpg" alt="nav">
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                        ...
                                        <li>
                                            ...
                                            <ul class="">
                                                ...
                                                <li><a class="mobile-menu-link" href="single-course-two.html">Course
                                                        Details v2</a></li>
                                                <li><a class="mobile-menu-link" href="single-course-three.html">Course
                                                        Details v3</a></li>
                                                <li><a class="mobile-menu-link" href="single-course-four.html">Course
                                                        Details v4</a></li>
                                                <li><a class="mobile-menu-link" href="single-course-five.html">Course
                                                        Details v5</a></li>
                                                <li><a class="mobile-menu-link" href="single-course-free.html">Course
                                                        Details Free</a></li>
                                            </ul>
                                            <ul class="">
                                            ...
                                            <div class="thumbnav-area">
                                                ...
                                                <a href="create-course.html" class="single-thumbnav">
                                                    <div class="icon">
                                                        <img src="frontend/assets/images/nav/04.png" alt="nav">
                                                    </div>
                                                ...
                                                <a href="lesson-details.html" class="single-thumbnav mash">
                                                    <div class="icon">
                                                        <img src="frontend/assets/images/nav/05.png" alt="nav">
                                                    </div>
                                                ...
                                                <a href="instructor.html" class="single-thumbnav">
                                                    <div class="icon">
                                                        <img src="frontend/assets/images/nav/06.png" alt="nav">
                                                    </div>
                                    ...
                                    <ul class="submenu">
                                        <li class="sub-dropdown">
                                            ...
                                            <ul class="submenu third-lvl base">
                                                ...
                                                <li><a class="mobile-menu-link" href="assignments.html">Assignments</a>
                                                </li>
                                                <li><a class="mobile-menu-link" href="certificate.html">Certificate</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="sub-dropdown">
                                            ...
                                            <ul class="submenu third-lvl base">
                                                ...
                                                <li><a class="mobile-menu-link" href="student-profile.html">My
                                                        Profile</a></li>
                                                <li><a class="mobile-menu-link" href="student-enroll-course.html">Enroll
                                                        Course</a></li>
                                                <li><a class="mobile-menu-link"
                                                        href="student-wishlist.html">Wishlist</a></li>
                                                <li><a class="mobile-menu-link" href="student-reviews.html">Reviews</a>
                                                </li>
                                                <li><a class="mobile-menu-link" href="student-quick-attempts.html">Quick
                                                        Attempts</a></li>
                                                <li><a class="mobile-menu-link" href="student-order-history.html">Order
                                                        History</a></li>
                                                <li><a class="mobile-menu-link"
